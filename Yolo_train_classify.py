...
comet_ml.init(project_name='Yolo_Classification')
...
models_to_load = {
    'yolov8n': {'path': '/home/majidi/D1/Hockey/yolo-classification-models/yolov8n-cls.pt',   'load': False},  # nano - 3.2 Million parameters
    'YOLOv8s': {'path': '/home/majidi/D1/Hockey/yolo-classification-models/yolov8s-cls.pt', 'load': False},   # small - 11.2 million parameters
    'YOLOv8m': {'path': '/home/majidi/D1/Hockey/yolo-classification-models/yolov8m-cls.pt', 'load': True},  # medium - 25.9 million parameters
    'YOLOv8l': {'path': '/home/majidi/D1/Hockey/yolo-classification-models/yolov8l-cls.pt',  'load': False},  # large - 43.7 million parameters
    'YOLOv8x': {'path': '/home/majidi/D1/Hockey/yolo-classification-models/yolov8x-cls.pt', 'load': False},  # Xlarge - 68.2 million parameters
}
